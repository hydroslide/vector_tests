...
def get_obj_str(obj):
    ...
    # print("obj.archetype.custom_type: {}".format(obj.archetype.custom_type))

    object_type = obj.archetype.custom_type

    if object_type == CustomObjectTypes.CustomType00:
        return 'cube'
    elif object_type == CustomObjectTypes.CustomType01:
        return 'big cube'
    elif object_type == CustomObjectTypes.CustomType02:
        return 'wall'
    elif object_type == CustomObjectTypes.CustomType03:
        return 'box'
...
def handle_object_appeared(event_type, event):
    ...
    msg = 'I just saw a {}!'.format(get_obj_str(event.obj))
    msg = '{} here'.format(get_obj_str(event.obj))
    g_robot.say_text(msg)
...
def handle_object_disappeared(event_type, event):
    ...
    msg = 'Hey, Where did the {} go?'.format(get_obj_str(event.obj))
    msg = '{} gone'.format(get_obj_str(event.obj))
    g_robot.say_text(msg)
